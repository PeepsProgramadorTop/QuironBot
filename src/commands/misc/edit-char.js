        ...
        collector.on("collect", async (interaction) => {
                ...
                options: [
                  {
                    ...
                    description:
                      "Altere os pontos de atributos disponíveis deste personagem.",
                    value: "editAtrPoints",
                    emoji: "🌟",
                  },
                  {
                    ...
                    description:
                      "Altere os valores da Constituição deste personagem.",
                    value: "editAtrCON",
                    emoji: "🫀",
                  },
                  {
                  ...
                  },
                  {
                    label: "Agilidade (AGI)",
                    description:
                      "Altere os valores da Agilidade deste personagem.",
                    value: "editAtrAGI",
                    emoji: "🦿",
                  },
                  {
                    ...
                    description:
                      "Altere os valores da Inteligência deste personagem.",
                    value: "editAtrINT",
                    emoji: "📜",
                  },
                  {
                    label: "Sabedoria (SAB)",
                    description:
                      "Altere os valores da Sabedoria deste personagem.",
                    value: "editAtrSAB",
                    emoji: "🦉",
                  },
                  {
                    label: "Carisma (CAR)",
                    description:
                      "Altere os valores da Carisma deste personagem.",
                    value: "editAtrCAR",
                    emoji: "✨",
                  },
                ],
            ...
            components: [
              {
                ...
                label:
                  "Avatar e Banner só são editáveis pelos próprios jogadores.",
                emoji: "🖼️",
                style: 2, // Secondary
              },
            ],
          ...
          collectorLevelsInfo.on("collect", async (interaction) => {
                  ...
                  components: [
                    {
                      ...
                      label: "Pontos de XP:",
                      placeholder:
                        "Digite os pontos de XP novos que este personagem terá (+1 nível a cada 1000).",
                  ...
                  components: [
                    {
                      ...
                      placeholder:
                        "Digite os pontos de XP mágicos novos que este personagem terá (+1 nível a cada 1000).",
            ...
            interaction
              ...
              .then(async (modalInteraction) => {
                const newXPValue =
                  modalInteraction.fields.getTextInputValue("xpInput");
                const newMagicXPValue =
                  modalInteraction.fields.getTextInputValue("magicXpInput");
          ...
          collectorStatusInfo.on("collect", async (interaction) => {
                  ...
                  components: [
                    {
                      ...
                      label: "HP Máximo:",
                      placeholder:
                        "Digite o novo valor de HP máximo para este personagem.",
                  ...
                  components: [
                    {
                      ...
                      label: "HP Atual:",
                      placeholder:
                        "Digite o novo valor de HP atual para este personagem.",
                  ...
                  components: [
                    {
                      ...
                      label: "Dinheiro:",
                      placeholder:
                        "Digite o novo valor em dólares que este personagem terá.",
                  ...
                  components: [
                    {
                      ...
                      label: "Dracmas:",
                      placeholder:
                        "Digite o novo valor em dracmas que este personagem terá.",
            ...
            interaction
              ...
              .then(async (modalInteraction) => {
                const newMaxHP =
                  modalInteraction.fields.getTextInputValue("maxHPInput");
                const newCurrentHP =
                  modalInteraction.fields.getTextInputValue("currentHPInput");
                const newMoneyValue =
                  modalInteraction.fields.getTextInputValue("moneyInput");
                const newDracmasValue =
                  modalInteraction.fields.getTextInputValue("dracmasInput");
