const { ComponentType, AttachmentBuilder } = require("discord.js");
...
module.exports = {
    ...
    options: [
      {
        ...
        name: "usuário",
        description:
          "O usuário que você quer que o bot liste os personagens pertencentes.",
        required: false,
      },
    ],
  },
  run: async ({ interaction }) => {
    const user = interaction.options.getUser("usuário")
      ? interaction.options.getUser("usuário")
      : interaction.user;
    ...
    function createCharacterListEmbed(characterData, pageNum, totalPageNum) {
      const embedMessage = [
        {
          color: 0x5865f2,
          title: `Você está visualizando ${characterData.info.name}... (${
            pageNum + 1
          }/${totalPageNum})`,
          author: {
